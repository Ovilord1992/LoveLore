...
- [ ] Переходы между сценами (fade, slide, dissolve анимации)
- [ ] Аудио-сервис (фоновая музыка через just_audio, звуковые эффекты)
- [ ] Анимации персонажей (появление fade_in, уход fade_out, смена эмоций)
- [ ] Реальные фоновые изображения вместо градиентных плейсхолдеров
- [ ] Реальные спрайты персонажей вместо плейсхолдеров (буква имени)
- [ ] Экран настроек (скорость текста, громкость музыки, автопрокрутка)
- [ ] Экран деталей новеллы (обложка на весь экран, описание, список глав, кнопка «Играть»/«Продолжить»)
- [ ] Шкала отношений (relationship_bar.dart)
- [ ] Автосохранение при выходе из игры
- [ ] Индикатор прогресса по главе
...
### Фаза 6: Расширенные функции ⬜ НЕ НАЧАТА
- [ ] Загрузка новелл с сервера (API + скачивание контент-паков)
- [ ] Система монетизации (премиум-выборы, внутриигровая валюта — алмазы)
- [ ] Профиль пользователя (аватар, статистика, достижения)
- [ ] Галерея разблокированных CG-артов
- [ ] Система достижений / бейджей
- [ ] Push-уведомления о новых главах/новеллах
- [ ] Мультиязычность (русский / английский)
- [ ] Гардероб (смена одежды персонажей)

### Фаза 7: Редактор новелл ⬜ НЕ НАЧАТА
- [ ] Веб-редактор для авторов (React/Vue)
- [ ] Визуальный редактор сцен (drag & drop)
- [ ] Превью сцены в реальном времени
- [ ] Экспорт новеллы в JSON-пакет
- [ ] Валидация сценария (проверка на битые ссылки, недостижимые сцены)

### Фаза 8: Публикация ⬜ НЕ НАЧАТА
